...
| AC-006 | Internal decrypt returns plaintext for valid reversible markers. | API | A valid API key and unexpired context exist for the user. | `POST /internal/decrypt` returns the original plaintext value. |
